        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskEntityId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskTagIds", x => new { x.TagsId, x.TaskEntityId });
                    table.ForeignKey(
                        name: "FK_TaskTagIds_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskTagIds_Tasks_TaskEntityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskTagIds_TaskEntityId",
                table: "TaskTagIds",
                column: "TaskEntityId");
        }
